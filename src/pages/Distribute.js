    ...
    <div className="page-section pg active" id="page-distribute">
      ...
      <section className="sec" style={{ background: '#fff' }}><div className="sec-in"><div className="dg">
        <div className="r">
          ...
          <div className="ccrd"><div className="ccrd-ico"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg></div><div><div className="cclbl">Email</div><div className="ccval">shubhlabh.limited@gmail.com</div><div className="ccsub">Business &amp; partnership enquiries</div></div></div>
